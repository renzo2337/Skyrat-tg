	...
	product_categories = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/suit/jacket/sinnerjacket = 1,
				/obj/item/clothing/suit/jacket/sinnerjacketshort = 1,
				/obj/item/clothing/suit/jacket/sinnerjacketcape = 1,
				/obj/item/clothing/accessory/sinnervest = 1,
				/obj/item/clothing/accessory/sinnervesttie = 1,
				/obj/item/clothing/under/misc/sinnerunder = 1,
				/obj/item/clothing/under/misc/sinnerunderstraps = 1,
				/obj/item/clothing/under/misc/dantuhunder = 1,
				/obj/item/clothing/suit/jacket/dantuhjacket = 1,
			),
		),
		list(
			"name" = "Animals",
